<script>
import {closeOverlay, notify, whatError} from "@/utils.js";
import axios from "axios";
import config from "@/config.json";

export default {
    name: "AlleregensComponent",
    data () {
        return {
            allergens: [],
            search: "",
    ...
    methods: {closeOverlay,
        async updateAllergens () {
            ...
            newUser.allergens = this.allergens;
            this.$store.dispatch("updateUser", newUser);

            closeOverlay('allergens', 'allergens_background');
